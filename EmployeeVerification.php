...
<title> Job Portal/EmployeeVarification</title>
...
<li class="topfirst"><a href="EducationVerification.php" style="height:40px;line-height:40px; width:265px; border-radius:15px 15px 0px 0px;   border:#000000 0px solid;"><div style="padding-left:0px;"><b> &nbsp;Education Verification</b></div></a></li>

<li style="height:2px;width:265px;"></li>
	
	<li class="toplast"><a href="EmployeeVerification.php" style="height:40px;line-height:40px;background-color:#000000; color:#FFFFFF;margin-top:0px; width:265px;"><div style="padding-left:0px;"><b> &nbsp;Employee Verification</b></div></a></li>
...
$server=mysql_query("select * from static where page='EmployeeVarification'");
...
<strong style="width:255px; height:auto;border: 0px #CCCCCC solid; font-size:24px;" align="center"> <b>Total Amount</b></strong>
			<div style="width:255px; height:auto;border:solid 0px #999900;background-color:#EFEFEF; font-size:40px; border-radius:17px 17px 17px 17px;"align="center">
