...
<body style=" background-repeat:repeat;background-image: url(images/back-gr_02.png); ">
...
<tr><td>
<!--left-->
<div style="width:600px; height:300px;background-color:#3069FF;border:0px #CCCCCC solid;float:left;"><a href="user_reg1.php"><img src="images/createaccount.png"></a></div>
<!--right-->

<div style="width:435px; height:300px; float:left;border:1px #CCCCCC solid;margin:auto; ">
 <form method="post" name="login" action="myaccount_dbc.php">
<table align='center' style="width:430px; height:298px;">
	...
	<tr><td style="padding-left:20px;">Forgot Password</td><td colspan='2' width='100px' align='center'><input type="submit" name="b1" value="Login"></td>
	</tr>
